...
- Multiple selected files are sent through one authenticated resumable session with one incoming consent request; 1 MiB chunks continue from the receiver's last offset after interruptions.
